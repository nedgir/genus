...
export class HealthMenuPage implements OnInit {
  ...
  ngOnInit() {
    this.pages = [
      ...
      { title: 'Care Report', component: "UnderDevelopmentPage", image: 'assets/LandingPage_Icons/CareReport.svg',count:'2' , date:'1/2/24/4:33pm'},
      { title: 'Vital Signs', component: "VitalSignsPage", image: 'assets/LandingPage_Icons/VitalSigns.svg',count:'3' , date:'1/2/24/4:33pm'},
      { title: 'Observations', component: "UnderDevelopmentPage", image: 'assets/LandingPage_Icons/Observations.svg',count:'6' , date:'1/2/24/4:33pm'},
      { title: 'Medications', component: "UnderDevelopmentPage", image: 'assets/LandingPage_Icons/Medications.svg',count:'8' , date:'1/2/24/4:33pm'},
      { title: 'Physicians', component: "UnderDevelopmentPage", image: 'assets/LandingPage_Icons/Physicians.svg',count:'9' , date:'1/2/24/4:33pm'},
      { title: 'Medical Visits', component: "UnderDevelopmentPage", image: 'assets/LandingPage_Icons/MedicalVisits.svg',count:'8' , date:'1/2/24/4:33pm'},
    ];

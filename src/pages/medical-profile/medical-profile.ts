...
export class MedicalProfilePage implements OnInit {
  ...
  ngOnInit() {
    this.pages = [
      { title: 'About POC', component: "MedicalProfilePage", image: 'assets/MedicalProfile_Icons/AboutPOC.svg',count:'1' , date:'1/2/24/4:33pm'},
      { title: 'Emergency Contact', component: "OpenInvitationsPage", image: 'assets/MedicalProfile_Icons/EmergencyContact.svg',count:'3' , date:'1/2/24/4:33pm'},
      ...
      { title: 'Allergies', component: "MembersPage", image: 'assets/MedicalProfile_Icons/Allergies.svg',count:'5' , date:'1/2/24/4:33pm'},
      { title: 'Medical Documents', component: "InformationPage", image: 'assets/MedicalProfile_Icons/MedicalDocuments.svg',count:'4' , date:'1/2/24/4:33pm'},

...
export class MedicalProfilePage implements OnInit {
  ...
  ngOnInit() {
    this.pages = [
      ...
      { title: 'Medical Conditions', component: "MedicalConditionPage", image: 'assets/MedicalProfile_Icons/MedicalConditions.svg',count:'7' , date:'1/2/24/4:33pm'},
      { title: 'Surgeries', component: "SurgeriesPage", image: 'assets/MedicalProfile_Icons/Surgeries.svg',count:'3' , date:'1/2/24/4:33pm'},
